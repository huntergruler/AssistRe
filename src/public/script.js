...
function addLicense() {
    ...
    .then(data => {
        ...
        console.log(data);
        row.innerHTML = `<tr id="${data.agentlicenseid}"> <td>${data.licensenumber}</td><td>${data.licensestate}</td><td>${data.agentlicenseid}</td><td></button><button onclick="deleteLicense(${data.agentlicenseid})">Delete</button></td></tr>`;
