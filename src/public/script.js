...
function addLicense() {
    ...
    .then(data => {
        ...
        console.log(data);
        row.innerHTML = `<td>${data.licensenumber}</td><td>${data.licensestate}</td><td>${data.agentlicenseid}</td><td></button><button onclick="deleteLicense(${data.id})">Delete</button></td>`;
